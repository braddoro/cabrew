...
isc.defineClass("myDonorContextMenu", "myMenu").addProperties({
	parent: this,
	callingListGrid: null,
	data: [
		{title: "Touch History",
			click: function(target, item, menu, colNum){
				var record = menu.callingListGrid.getSelectedRecord();
				isc.DonationTouch.create({
					corporateDonationID_fk: record.corporateDonationID,
					left: isc.Math.random(200),
					name: "Logs for " + record.corporateDonationID,
					title: "Logs for " + record.corporateDonationID,

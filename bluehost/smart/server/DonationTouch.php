...
$table = 'donationTouches';
$primaryKey = 'donationTouchID';
$conn = new Connect();
$db = $conn->conn();
if(!$db->isConnected()){
...
case 'fetch':
	$where = '1=1';
	if(isset($_REQUEST['corporateDonationID_fk'])){
		$where .= " and corporateDonationID_fk = " . intval($_REQUEST['corporateDonationID_fk']);
	}
	break;
case 'add':
